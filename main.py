...
# === CONFIGURATION ===
PDF_FOLDER = r'C:\Users\ajens\Internship Project API\references'
...
def extract_properties_with_huggingface(text):
    ...
    try:
        ...
        return eval(match.group()) if match else None
...
def main():
    ...
    for filename, material_name in PDF_FILES.items():
        ...
        if not raw_properties:
            print("❌ Failed to extract properties with Hugging Face.")
            continue
